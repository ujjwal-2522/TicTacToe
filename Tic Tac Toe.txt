...
public class TicTacToe_Project {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TicTacToe_Project window = new TicTacToe_Project();
	...
	{   // For Player X Only//
		...
		{
			JOptionPane.showMessageDialog(frame,"Player NO Wins","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
	...
	private void initialize() {
		frame = new JFrame();
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\ujjwal.soni\\Downloads\\tic.png"));
		...
		btn1.setFont(new Font("Tahoma", Font.BOLD, 72));
		...
		btn2.setFont(new Font("Tahoma", Font.BOLD, 72));
		...
		btn3.setFont(new Font("Tahoma", Font.BOLD, 72));
		...
		btn4.setFont(new Font("Tahoma", Font.BOLD, 72));
		...
		btn5.setFont(new Font("Tahoma", Font.BOLD, 72));
		...
		btn6.setFont(new Font("Tahoma", Font.BOLD, 72));
		...
		btn7.setFont(new Font("Tahoma", Font.BOLD, 72));
		...
		btn8.setFont(new Font("Tahoma", Font.BOLD, 72));
		...
		btn9.setFont(new Font("Tahoma", Font.BOLD, 72));
